...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/19 19:41:46 by fself             #+#    #+#             */
/*   Updated: 2020/07/19 19:41:49 by fself            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

int		check_win_size(int key, t_data **matrix)
{
...
void	full_screen(t_data **matrix)
{
	static int old_x;
	static int old_y;
...
void	change_window_size(int key, t_data **matrix)
{
